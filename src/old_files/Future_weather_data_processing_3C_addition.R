...
fname = paste0(stid, "_weather_2080")
...
#Change year to 2080
#replace(wd$year, wd$year==2018, 2080)
...
wdsum <- data.frame(bin1 = wd$bins, bin2 = wd$bins+5,
                    ...
                    TAIR = wd$TAIR, FTAIR = futureTAIR, RELH = wd$RELH, PRES = wd$PRES)          


save(wdsum, file = paste0(fname, ".Rdata"))
#save(wdsum, file = paste0("ERIC_weather_2080", ".Rdata"))
