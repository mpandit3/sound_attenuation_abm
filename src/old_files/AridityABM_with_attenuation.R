...
Song_volume = 80     #song sound pressure in db
Song_detection = 50  #minimum sound pressure for detection
Song_freq = 6000     #relevant frequency in Hz
...
#Load some compiled weather data
load("woodward_data.Rdata")
...
while(prod(Hx$done)==0) {
  ...
  #Calculate call radius for temperature data table
