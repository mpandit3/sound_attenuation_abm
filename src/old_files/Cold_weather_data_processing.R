...
###Hot Weather patterns, using data from ERIC Station year 2011 on dates 6/22-6/26
...
w <- okmts(begintime="2011-06-22 00:00:00",
          endtime="2011-06-26 23:55", 
          variables = c("TAIR", "RELH","PRES"),
          station="eric",  
          localtime=F) #Need to download the data into UTC

write.csv(w[1:288,], file = "data/ERIC_weather_2011/20110622.csv")
write.csv(w[289:576,], file = "data/ERIC_weather_2011/20110623.csv")
write.csv(w[577:864,], file = "data/ERIC_weather_2011/20110624.csv")
write.csv(w[865:1152,], file = "data/ERIC_weather_2011/20110625.csv")
write.csv(w[1153:1440,], file = "data/ERIC_weather_2011/20110626.csv")


#Use station ID to access folder and get a list of data files
fname = paste0(stid, "_weather_2011")
